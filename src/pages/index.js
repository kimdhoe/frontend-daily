  ...
  <Layout>
    ...
    <ul css={[ styles.list ]}>
      <Item
        ...
        url={'https://medium.com/@kimdhoe1/7-defensive-javascript-46bf4172e273'}
      />
      <Item
        number={6}
        date={'2019. 01. 11'}
      ...
      <Item
        ...
        url={'https://medium.com/@kimdhoe1/5-a-comprehensive-look-back-at-front-end-in-2018-f08b852b4e97'}
      />
      <Item
        number={4}
        date={'2019. 01. 09'}
